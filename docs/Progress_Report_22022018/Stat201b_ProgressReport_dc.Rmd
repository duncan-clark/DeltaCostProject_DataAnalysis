...
####Data Preparation:
We first found and cleaned data on state and year specific GDP per capita and unemployment so they could be merged with our final dataset, as the two studies above included them in their models. Because graduation rates are only available starting in academic year 2003, we started by keeping years past then in the data, which left us with 553 institutions. We then thinned our sample out in the following way:
...
- Pell grants $s per full time equivalent(fte) student
